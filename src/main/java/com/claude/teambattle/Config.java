...
public class Config
{
	...
	static
	{
		...
		RESTORE_WORLD = b
			...
			.define("restoreWorld", true);

		RESTORE_SPEED = b
			.comment("Quanti blocchi ripristinare per tick a fine partita (piu' alto = piu' veloce ma piu' lag)")
			.defineInRange("restoreSpeedPerTick", 2000, 100, 100000);
